...
q_d  =  beta_d * ( mu_d(+1)/mu_d) * ( RK_d(+1)/PC_d(+1) + (1-delta_d) * q_d(+1) ) ;
...
1 = beta_d * ( mu_d(+1)/mu_d  * E_d(+1)/E_d ) * Ra / ( ( 1 + zeta_d*(a_df - a_df_ss ) ) * picpi_d(+1) );
...
% ------------------------------------------------------
% (55) Definition of q_i (Tobin's q)
q_f  =  beta_f * ( mu_f(+1)/mu_f) * ( RK_f(+1)/PC_f(+1) + (1-delta_f) * q_f(+1) ) ;
...
%Y_f_2 = ( (K_f_2(-1)^(1 - alphaL_f_2)) * (L_f_2^(alphaL_f_2)) )^(alphaM_f_2) * ( M_f_2^(1 - alphaM_f_2) );
...
R_f / R_ss_f = ( (R_f(-1) / R_ss_f)^rho_R_f ) * (   ((picpi_f / picpi_ss_f)^phi_pi_f)  *  ((Y_VA_f / Yd_VA_ss_f)^phi_y_f) )^(1 - rho_R_f);
...
tauC_d_1 = (1 - rho_tauC_d_1)*tauC_d_1_ss + rho_tauC_d_1*tauC_d_1(-1) + eps_tauC_d_1;
tauC_d_2 = (1 - rho_tauC_d_2)*tauC_d_2_ss + rho_tauC_d_2*tauC_d_2(-1) + eps_tauC_d_2;
tauC_f_1 = (1 - rho_tauC_f_1)*tauC_f_1_ss + rho_tauC_f_1*tauC_f_1(-1) + eps_tauC_f_1;
tauC_f_2 = (1 - rho_tauC_f_2)*tauC_f_2_ss + rho_tauC_f_2*tauC_f_2(-1) + eps_tauC_f_2;
tauM_d_1 = (1 - rho_tauM_d_1)*tauM_d_1_ss + rho_tauM_d_1*tauM_d_1(-1) + eps_tauM_d_1;
tauM_d_2 = (1 - rho_tauM_d_2)*tauM_d_2_ss + rho_tauM_d_2*tauM_d_2(-1) + eps_tauM_d_2;
tauM_f_1 = (1 - rho_tauM_f_1)*tauM_f_1_ss + rho_tauM_f_1*tauM_f_1(-1) + eps_tauM_f_1;
tauM_f_2 = (1 - rho_tauM_f_2)*tauM_f_2_ss + rho_tauM_f_2*tauM_f_2(-1) + eps_tauM_f_2;
end;



shocks;
var eps_tauC_d_1; stderr 0.01;
var eps_tauC_d_2; stderr 0.01; 
var eps_tauC_f_1; stderr 0.01;
var eps_tauC_f_2; stderr 0.01;
var eps_tauM_d_1; stderr 0.01;
var eps_tauM_d_2; stderr 0.01;
var eps_tauM_f_1; stderr 0.01;
var eps_tauM_f_2; stderr 0.01;
end;


@#include "steady_state.mod"
